...
electrons and ions in complex electromagnetic orbits. Since their discovery,
...
and drift about the Earth. During active times, when conditions 
change on time scales shorter than the periods of motion, 
adiabaticity can be broken and particle motion can not be
simply decomposed into the aforementioned components. When adaibatic motion 
is violated, it can be represented diffusively along each component 
via the \emph{Fokker-Plank} equation yielding a powerful picture of 
radiation belt dynamics \citep{schulz2012particle}.

The third invariant represents the total magnetic flux en- closed within 
a full particle orbit. It is common to use a nor- malized form of this, the 
