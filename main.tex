...
\begin{figure}[h]
  \centering
  \mbox{
    \subfigure[Posterior Samples $\alpha$\label{subfig:alpha}]{\includegraphics[width=0.35\textwidth]{histogram_alpha_posterior}}\quad
    \subfigure[Posterior Samples $\beta$\label{subfig:beta}]{\includegraphics[width=0.35\textwidth]{histogram_beta_posterior}}\quad
    \subfigure[Posterior Samples $b$\label{subfig:b}]{\includegraphics[width=0.35\textwidth]{histogram_b_posterior}}
  }
