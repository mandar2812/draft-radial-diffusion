...
\ref{subfig:alpha}, \ref{subfig:beta} and \ref{subfig:b} respectively. Figures \ref{subfig:alpha}, 
\ref{subfig:beta}, \ref{subfig:gamma2} and \ref{subfig:b} show the same for parameters of the
...
to scale well with respect to high dimensional basis function expansions.
